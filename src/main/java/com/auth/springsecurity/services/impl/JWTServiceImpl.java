...
public class JWTServiceImpl implements JWTService {
    ...
    public String generateRefreshToken(Map<String,Object> extraCliams, UserDetails userDetails){
        return Jwts.builder().setClaims(extraCliams).setSubject(userDetails.getUsername())
                .setIssuedAt(new Date(System.currentTimeMillis()))
